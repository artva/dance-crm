...
4. For each review comment, decide which category it falls into:
   ...
   - **Requires a correction** — update `DESIGN.md` accordingly, then reply to the comment explaining what you changed and why.
5. Commit: `design: address review on PR #$PR_NUMBER\n\n<2–4 bullet points summarising which sections were changed and what was corrected>`
